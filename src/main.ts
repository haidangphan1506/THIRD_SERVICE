...
async function bootstrap() {
  ...
  if (!rabbitMqUrl) {
    throw new Error('RABBITMQ_URL not found — required to start the third-service RMQ listener');
  }
  ...
  Logger.log(`[THIRD] RMQ listener bound to queue "third_queue"`, 'Bootstrap');
